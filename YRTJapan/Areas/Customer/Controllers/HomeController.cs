...
namespace YRTJapan.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            response.ListCars = carList.Take(12).ToList();
        ...
        public async Task<IActionResult> SearchCars(CarSearchViewModel searchModel)
        {
            try
            {
                ...
                var totalLotsHtml = await RenderPartialViewToStringAsync("_TotalLots", "Total Cars In Stock: " + totalLotscars);
        ...
        public IActionResult GetFavouriteCars(int page = 1, int pageSize = 3)
        {
            ...
            //{
            //    return Unauthorized(); // or return empty Json if preferred
            //}

            var cars = _context.Favourites
                        .Where(f => f.UserId == userId) // 🔍 Filter by logged-in user
