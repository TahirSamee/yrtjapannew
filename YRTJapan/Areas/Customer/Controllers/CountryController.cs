...
namespace YRTJapan.UI.Areas.Customer.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public async Task<IActionResult> Tanzania(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Tanzania", response); // Make sure your View model is DropDownDataList
        }
     
        public async Task<IActionResult> Kenya(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Kenya", response); // Make sure your View model is DropDownDataList
        }

        public async Task<IActionResult> DRCongo(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("DRCongo", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> Mozambique(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Mozambique", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> Uganda(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Uganda", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> SaintVincent(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("SaintVincent", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> Guyana(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Guyana", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> Grenada(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Grenada", response); // Make sure your View model is DropDownDataList
        }
       public async Task<IActionResult> Jamaica(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Jamaica", response); // Make sure your View model is DropDownDataList
        }
        public async Task<IActionResult> Barbados(CarSearchViewModel filters, int page = 1)
        {
            int itemsPerPage = 12;
            int offset = (page - 1) * itemsPerPage;
            ...
            return View("Barbados", response); // Make sure your View model is DropDownDataList
        }
