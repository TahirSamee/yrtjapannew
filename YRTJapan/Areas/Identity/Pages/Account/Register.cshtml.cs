...
namespace YRTJapan.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            Input = new()
            {
                GenderList = CommonData.GetGenderList,
                CountryList = _countryService.GetDBCountryData
            };
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Input.Role = StaticDetails.ROLE_CUSTOMER;
            ...
            Input.GenderList = CommonData.GetGenderList;
            Input.CountryList = _countryService.GetDBCountryData;
            return Page();
        }
