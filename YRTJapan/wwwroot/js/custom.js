...
function updateJapanTime() {
    const options = { timeZone: 'Asia/Tokyo', hour: '2-digit', minute: '2-digit', hour12: true };
    document.getElementById('japan-time').textContent = new Intl.DateTimeFormat('en-US', options).format(new Date());
}

// Ensure DOM is Loaded Before Running Script
document.addEventListener("DOMContentLoaded", function () {
    updateJapanTime(); // Initial call
    setInterval(updateJapanTime, 60000); // Update every minute
});