...
namespace YRTJapan.DataAccess.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private void SeedAdminUser(ModelBuilder modelBuilder)
        {
            ...
            {
                Id = adminUserId,
                UserName = "admin@yrtjapan.com",
                NormalizedUserName = "admin@yrtjapan.com",
                Email = "admin@yrtjapan.com",
                NormalizedEmail = "admin@yrtjapan.com",
                EmailConfirmed = true,
                SecurityStamp = string.Empty,
                FullName = "Admin",
                Gender = "Male",
            ...
            string password = "MianYrtjapan";
            //  string password = "Engrvidhu@321";AQAAAAIAAYagAAAAEHOgCpIrCJh4234ZcBgbLZth+L+MPLOx6UNIZTR2Mld/XRm2mGvqEWFmmbjigPLrGw==
